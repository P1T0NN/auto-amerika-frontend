	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline:
					"bg-transparent border border-accent-foreground/20 text-accent-foreground shadow-xs hover:bg-accent-foreground hover:text-accent dark:border-input dark:hover:bg-input/50",
